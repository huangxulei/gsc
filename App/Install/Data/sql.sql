...
CREATE TABLE `app_member_type` (
  `typeid` tinyint(3) NOT NULL AUTO_INCREMENT,
...
(17, '查看列表', 16, 'System', 'menuViewList', '', 0, 0, '1'),
...
(45, '临时文件', 14, 'System', 'fileList', '', 0, 0, '1'),

(46, '查看列表', 43, 'Member', 'memberViewList', '', 0, 0, '1'),
(47, '添加用户', 43, 'Member', 'memberAdd', '', 0, 0, '1'),
(48, '编辑用户', 43, 'Member', 'memberEdit', '', 0, 0, '1'),
(49, '删除用户', 43, 'Member', 'memberDelete', '', 0, 0, '1'),
(50, '用户详情', 43, 'Member', 'memberView', '', 0, 0, '1'),

(51, '添加分类', 44, 'Member', 'typeAdd', '', 0, 0, '1'),
(52, '编辑分类', 44, 'Member', 'typeEdit', '', 0, 0, '1'),
(53, '删除分类', 44, 'Member', 'typeDelete', '', 0, 0, '1'),
(54, '分类排序', 44, 'Member', 'typeOrder', '', 0, 0, '1'),
(55, '查看列表', 44, 'Member', 'typeViewList', '', 0, 0, '1'),

(56, '栏目权限', 13, 'Admin', 'roleCategory', '', 0, 0, '1'),
(57, '菜单导出', 16, 'System', 'menuExport', '', 0, 0, '1'),
(58, '菜单导入', 16, 'System', 'menuImport', '', 0, 0, '1'),
(59, '栏目导出', 36, 'Category', 'categoryExport', '', 0, 0, '1'),
(60, '栏目导入', 36, 'Category', 'categoryImport', '', 0, 0, '1');


DROP TABLE IF EXISTS `app_link`;
DROP TABLE IF EXISTS `app_chat_customgroup`;
DROP TABLE IF EXISTS `app_chat_pals`;
DROP TABLE IF EXISTS `app_chat_session`;
DROP TABLE IF EXISTS `app_chat_transfer_fileinfo`;
DROP TABLE IF EXISTS `app_chat_txt`;
DROP TABLE IF EXISTS `app_chat_users`;
